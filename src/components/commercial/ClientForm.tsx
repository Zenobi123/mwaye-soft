...
interface Props {
  onSubmit: (v: { nom: string; email?: string; telephone?: string; adresse?: string; type_client?: string }) => void;
  isPending: boolean;
}
...
export function ClientForm({ onSubmit, isPending }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    onSubmit({ nom, email: email || undefined, telephone: telephone || undefined, adresse: adresse || undefined, type_client: type });
